...
- Don't accept anything you find on the internet (StackOverflow, Github, etc) without understanding how it works. Vet all solutions against the API documentation and source code (when available). It may be the accepted answer, but that does not mean it's correct or that it is still current.
